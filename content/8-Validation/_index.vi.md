...
*Bạn có thể xem chi tiết mã nguồn và hướng dẫn đầy đủ tại [đây](../6-WebSocket/)* (Liên kết tới phần cấu hình WebSocket).
...
*Tham khảo chi tiết các bước tại [đây](../7-CloudFront/) (Liên kết tới phần cấu hình CloudFront).*
