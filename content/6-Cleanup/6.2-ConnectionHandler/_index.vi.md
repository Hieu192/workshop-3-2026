...
5. Cấp quyền: Vào tab **Configuration** -> **Permissions** để cấp quyền cho Lambda được thao tác trên bảng `simple-websocket-connections`. Nhấn vào WebSocketConnectionHandler-role-xxxx để mở tab IAM
